...
[pred, yhat_pred] = obs_PerceptualBias_unitsq_sgm_tbt_sim(r, infStates, p_sgm);

%% Run sim for continuous data modality (logRTs)
[logReactionTime, yhat_rt] = obs_PerceptualBias_logrt_linear_binary_sim(r, infStates, p_logRT);
